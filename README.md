...
### TODO
- add a limitation of the attributes (products, categories) sent to ElasticSearch (in progress)
 -- split catalog module to smaller modules: attributes, category, product
